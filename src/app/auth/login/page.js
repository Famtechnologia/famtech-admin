    ...
    try {
      ...
      if (response.ok) {
        if (formState.rememberMe) {
          ...
          document.cookie = `famtech-token=${response.token}; expires=${expires}; path=/; SameSite=Lax`;
        } else {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors disabled:bg-gray-50 disabled:cursor-not-allowed text-gray-700"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors disabled:bg-gray-50 disabled:cursor-not-allowed text-gray-700"
